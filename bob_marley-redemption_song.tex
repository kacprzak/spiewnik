\begin{song}{Redemption Song}{G}{1980}{Bob Marley}{}{}
  ...
  \begin{SBVerse}
    ...
    \Ch{C}{sold} I to the \Ch{G/B}{merchant} \Ch{Am}{ships}

    \Ch{G}{Minutes} after they took \Ch{Em}{I}

    \Ch{C}{from} the \Ch{G/B}{bottomless} \Ch{Am}{pit.}

    But my \Ch{G}{hand} was \Ch{Em7}{made} \Ch{C}{strong}

    by the \Ch{C}{hand} of \Chr{G/B}{the} \Ch{Am}{Almighty.}
  ...
  \begin{SBVerse}
    ...
    none but \Ch{C}{ourselves} can \Ch{G/B}{free} our \Ch{Am}{minds}.

    Have no \Ch{G}{fear} for atomic \Ch{Em}{energy}

    'cause none of \Ch{C}{them} can \Ch{G/B}{stop} the \Ch{D}{time}.

    How long \Ch{G}{shall} they kill our \Ch{Em7}{prophets}

    While we \Ch{C}{stand} \Ch{G/B}{aside} and   \Ch{Am}{look}?

    Some say \Ch{G}{it's} just a part of \Ch{Em}{it}

    we've got \Ch{C}{to} \Ch{G/B}{fulfill} the    \Ch{D}{book.}
  \end{SBVerse}
