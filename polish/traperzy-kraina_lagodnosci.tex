\beginsong{Kraina łagodności}[by={T-Raperzy znad Wisły}]
  \beginchorus
    \[C]{Dabudibuda} o \[D\mi]{naturze} ludzkiej \[G]pieśń jest \[A\mi]{ta}
    Dabudibuda o naturze ludzkiej pieśń jest ta
  \endchorus
  \beginverse
    \[A\mi]{Zwiedzawszy} areały pustych dusz przestrzeni
    \[D\mi]{Rzeźbimy} w glinie uczuć ponadczasowy dzban
    \[G]{I myśli} naszych prądy jak rogi dwóch jeleni
    \[A\mi]{ku sobie} rwą na przeciw \[E]{nim rui} poczną tan
  \endverse
  \beginchorus
