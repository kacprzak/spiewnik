\beginsong{Kołysanka Pijacka}[cr={1994}, by={Alosza Awdiejew, Włodzimerz Wysocki}]
  \beginverse
    \[E7]{Jak} po naszemu, to wypiliśmy \[A\m]{niewiele}
    \[G7]{To} nie z kieliszka, no, powiedz \[C]{Miszka} \[A7]{}
    \[D\m]{I gdyby} wódki nie pędzono jakich \[A\m]{śmieci},
    \[E7]{To} nie zaszkodziłby nam ten literek \[A\m]{trzeci}
  \endverse
  \beginverse
  ...
  \beginverse
    ...
    \lrep\[D\m]{Bo} w życiu mało jest dobrego, wiele \[A\m]{złego}
    \[E7]{A co} tam gadać, no, śpij \[A\m]{kolego} \[A7]{} \rrep \rep{2}
  \endverse
\endsong
