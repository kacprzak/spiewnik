\beginsong{Kraina łagodności}{C}{}{T-Raperzy znad Wisły}{}{}
  \beginchorus
    \[C]{Dabudibuda} o \[Dm]{naturze} ludzkiej \[G]pieśń jest \[Am]{ta}

    Dabudibuda o naturze ludzkiej pieśń jest ta
  \endchorus
  \beginverse
    \[Am]{Zwiedzawszy} areały pustych dusz przestrzeni

    \[Dm]{Rzeźbimy} w glinie uczuć ponadczasowy dzban

    \[G]{I myśli} naszych prądy jak rogi dwóch jeleni

    \[Am]{ku sobie} rwą na przeciw \[E]{nim rui} poczną tan
  \endverse
  \beginchorus
