...
\begin{song}{Anyway the Wind Blows}{Gis}{1991}{Fred Mollin}{}{}
  ...
  \begin{SBChorus}
    \Ch{Gis}{Anyway} the wind blows \Ch{Cis}{}
    
    \Ch{Dis}{it blows right back to} me
  ...
  \end{SBChorus}
	...
	\begin{SBVerse}
	  \Ch{Gis}When the morning comes
	  
	  \Ch{Dis}brings the shining light
	  
	  \Ch{Cis}when the nighttime comes
	  
	  \Ch{Dis}darkness runs so bright
	\end{SBVerse}
