...
\addcontentsline{toc}{subsection}{Kontestacja}
\begin{song}{Kontestacja}{}{1990}{Big Cyc}{}{}
	\begin{SBVerse}
	\Ch{F}{Włosy} będę miał na \Ch{G}{cukier}

	\Ch{C}{A agrafkę} wepnę w \Ch{Am}{kuper}

	\Ch{F}{Zrobią} zdięcia mi w "\Ch{G}{Non stopie}"

	\Ch{C}{Patrzcie} co za dziwny chłopiec
	...
	\end{SBVerse}
	\begin{SBChorus}
	\Ch{F}{Kontestacja}, \Ch{G}{kontestacja}

	\Ch{C}{To} jest dobre na \Ch{Am}{wakacjach}

	\Ch{F}{A już} w szkole wszyscy grzeczni

	\Ch{G}{Uczesani} i bezpieczni
	\end{SBChorus}
	\begin{SBVerse}
...
\begin{song}{Anyway the Wind Blows}{D}{1991}{Fred Mollin}{}{}
  ...
  \begin{SBChorus}
    \Ch{D}{Anyway} the wind blows \Ch{G}{}
    
    \Ch{A}{it blows right back to} me
  ...
  \end{SBChorus}
	...
	\begin{SBVerse}
  \Ch{D}When the morning comes
  
  \Ch{A}brings the shining light
  
  \Ch{G}when the nighttime comes
  
  \Ch{A}darkness runs so bright
	\end{SBVerse}
